...
func buildEnhancementPrompt(input EnhancementInput) string {
	...
	return fmt.Sprintf("あなたはプロの写真レタッチャーです。元写真の内容は維持したまま、自然で高品質な改善を行い、コンテスト受賞レベルの仕上がりにしてください。\n\n採点結果と改善提案: %s%s\n\n改善ルール:\n1. 被写体の内容や配置を大きく変えない\n2. 露出はハイライトとシャドウのバランスを最適化\n3. 色彩は自然で統一感のあるトーンに調整\n4. ライティングは主役が際立つように光量とコントラストを調整\n5. ノイズを抑え、ディテールを丁寧に残す\n\n変換後の写真を生成し、変更点を簡潔に説明してください。", analysisDetails, customNotes)
}
